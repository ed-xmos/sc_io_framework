...
void dsp_auto_thread0(chanend_t* c_source, chanend_t* c_dest, module_instance_t** modules) {
	...
	SELECT_RES(
		...
		cascaded_biquads_control(modules[3]->state, &modules[3]->control);
		control_done = true;
...
adsp_pipeline_t * adsp_auto_pipeline_init() {
	...
	static pipeline_config_t config0 = { .checksum = {224, 66, 211, 128, 238, 93, 230, 79, 173, 2, 148, 143, 241, 45, 205, 227} };
	...
	static cascaded_biquads_config_t config3 = { .left_shift = {0, 0, 0, 0, 0, 0, 0, 0}, .filter_coeffs = {839528639, -1679057279, 839528639, 1649955220, -634417514, 848230047, -1696460094, 848230047, 1667056403, -652121961, 865725974, -1731451947, 865725974, 1701441764, -687720307, 892169957, -1784339914, 892169957, 1753413056, -741524947, 927703577, -1855407154, 927703577, 1823248532, -813823952, 972331088, -1944662176, 972331088, 1910956552, -904625976, 1025724397, -2051448794, 1025724397, 2015892304, -1013263460, 1073741824, 0, 0, 0, 0} };

            static cascaded_biquads_state_t state3;
            static uint8_t memory3[_ADSP_MAX(1, CASCADED_BIQUADS_REQUIRED_MEMORY(2, 2, 1))];
            ...
            adsp_auto.modules[3].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[3].control.module_type = e_dsp_stage_cascaded_biquads;
                adsp_auto.modules[3].control.num_control_commands = NUM_CMDS_CASCADED_BIQUADS;
                cascaded_biquads_init(&adsp_auto.modules[3], &allocator3, 3, 2, 2, 1);
